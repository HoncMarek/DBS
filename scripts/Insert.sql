...
VALUES 
	...
	('nemcl','Èeská Lípa', 'Nádražní 16', '7:00', '13:00')
...
VALUES 
	...
	('Eva', 'Evièka', 'Mgr', (Select top 1 Id from [Location] where Name Like 'Poboèka KNL - JBC')),
...
VALUES 
	...
	('Krevní test', 'Odbìr krve', 250, 5),
	('Tìhotenský test', null, 500, 10),
	('HIV', null, 1500, 45),
	('Wegener', null, 2000, 60),
	('Rakovina', 'Vyšetøení podle podezdøení', 5000, 120),
	('Žluèové kameny', null, 900, 15),
